package gordon.api.spring;

import java.util.Arrays;
import java.util.Collections;

import gordon.api.security.AuthUserDetailsService;
import gordon.api.web.JwtRequestAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .addFilterBefore(jwtRequestAuthenticationFilter, BasicAuthenticationFilter.class)
                .cors().and()
